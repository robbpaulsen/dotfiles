...
TUXEDO THEME
Tuxedo theme provides icons meant for a look and feel quite familiar to Linux users (Ubuntu distribution, and Gnome are the main sources of inspiration), also trying to be familiar to Windows and macOS users.
